...
export function Input({
  ...
  return (
    <input
      className={cn(
        "w-full rounded-lg border border-stone-300 bg-white px-3 py-2 text-sm outline-none ring-stone-400 focus:ring-2",
        className,
      )}
      {...props}
    />
...
export function Select({
  ...
  return (
    <select
      className={cn(
        "rounded-lg border border-stone-300 bg-white px-3 py-2 text-sm outline-none ring-stone-400 focus:ring-2",
        className,
      )}
      {...props}
    />
